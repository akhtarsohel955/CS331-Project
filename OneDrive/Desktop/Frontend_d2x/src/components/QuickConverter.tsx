...
const fileFormats: FileFormat[] = [
  // 📄 DOCUMENT FORMATS - All fully supported
  {
    id: 'pdf',
    name: 'PDF',
    extension: 'pdf',
  ...
  // 🖼️ IMAGE FORMATS - All fully supported
  {
    id: 'jpg',
    name: 'JPG',
    extension: 'jpg',
  ...
  // 📊 SPREADSHEET FORMATS - All fully supported
  {
    id: 'xls',
    name: 'XLS',
    extension: 'xls',
  ...
  // 🎯 PRESENTATION FORMATS - All fully supported
  {
    id: 'ppt',
    name: 'PPT',
    extension: 'ppt',
  ...
  // 📁 ARCHIVE FORMATS - All fully supported
  {
    id: 'zip',
    name: 'ZIP',
    extension: 'zip',
  ...
  // 🎵 AUDIO FORMATS - All fully supported
  {
    id: 'mp3',
    name: 'MP3',
    extension: 'mp3',
  ...
  // 🎬 VIDEO FORMATS - All fully supported
  {
    id: 'mp4',
    name: 'MP4',
    extension: 'mp4',
  ...
  // 🔧 DATA FORMATS - All fully supported
  {
    id: 'json',
    name: 'JSON',
    extension: 'json',
